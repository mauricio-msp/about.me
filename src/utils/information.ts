        ...
        info: [
          {
            ...
            description:
              'Bachelor of Information Systems at Estácio do Ceará College - Moreira Campos Unit, in the city Fortaleza-CE, Brazil. 2016 - 2020.',
          },
          {
            title: 'Computer Technician',
            category: 'academic education',
            description:
              'Computer technician at Edson queiroz State Vocational Education School (EEEP), in the city of Cascavel-CE, Brazil. 2013 - 2015.',
          },
        ],
      },
      {
    ...
    more: [
        ...
        info: [
          {
            ...
            description:
              'Bacharel em Sistemas de Informação pela Faculdade Estácio do Ceará - Unidade Moreira Campos, na cidade Fortaleza-CE, Brasil. 2016-2020.',
          },
          {
            title: 'Técnico em Informática',
            category: 'formação acadêmica',
            description:
              'Técnico de informática da Escola Estadual de Educação Profissional Edson Queiroz (EEEP), na cidade de Cascavel-CE, Brasil. 2013-2015.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        info: [
          {
            title: 'JavaScript/Typescript',
            category: 'experiência na ferramenta',
            description: '',
          },
          {
            title: 'Node.JS',
